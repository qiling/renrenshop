	...
	<div class="container-fluid footer text-center" role="footer">	
		<div class="friend-link">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?>
				<a href="http://www.hejiewl.com">合界官网</a>
				<a href="http://www.hejiewl.com">系统开发</a>
				<a href="https://promotion.aliyun.com/ntms/yunparter/invite.html?userCode=zj61scjr">服务器购买</a>
				<a href="http://wpa.qq.com/msgrd?v=3&uin=2339778846&site=qq&menu=yes">联系客服</a>
			<?php  } else { ?>
				<?php  echo $_W['setting']['copyright']['footerright'];?>
			<?php  } ?>
		</div>
		<div class="copyright"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.hejiewl.com"><b>合界网络</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2019 <a href="http://www.hejiewl.com">www.hejiewl.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
