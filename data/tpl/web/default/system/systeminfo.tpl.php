...
<div class="main">
	...
	<table class="table we7-table table-hover site-list" id="system-info" ng-controller="systemInfoCtrl" ng-cloak>
		...
		<tr>
			...
			<td class="text-left">WeEngine <?php  echo IMS_VERSION;?> Release <?php  echo IMS_RELEASE_DATE;?> &nbsp; &nbsp;
				<a href="https://item.taobao.com/item.htm?id=564678619752" target="_blank" style="color: #428bca;">查看最新版本</a>
			</td>
		</tr>
		<tr>
	...
	<table class="table we7-table table-hover site-list">
		...
		<tr>
			<td class="text-left">交流论坛</td>
			<td>
				<a target="_blank" href="http://bbs.we7.cc" style="color: #428bca;">系统论坛</a>
			</td>
		</tr>
		<tr>
			<td class="text-left">相关链接</td>
			<td>
				<a href="http://bbs.we7.cc/" class="lightlink2" target="_blank" style="color: #428bca;">系统</a>&nbsp;&nbsp;
				<a href="https://www.330code.com/" class="lightlink2" target="_blank" style="color: #428bca;">购买授权</a>&nbsp;&nbsp;
				<a href="https://www.330code.com/" class="lightlink2" target="_blank" style="color: #428bca;">更多模块</a>&nbsp;&nbsp;
