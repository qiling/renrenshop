	...
	<div class="panel we7-panel">
		...
		<div class="panel-body we7-padding">
			...
			<div class="col-lg-6">
				...
				<div>
					<a href="<?php  echo $authurl;?>" class="btn btn-primary">授权添加熊掌号</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div ng-if="account.isconnect == 0">
						<p># 检查熊掌号配置</p>
						<p># 编辑熊掌号 <a ng-href="{{links.post}}acid={{account.acid}}&uniacid={{account.uniacid}}"><?php  echo $account['name'];?></a></p>
