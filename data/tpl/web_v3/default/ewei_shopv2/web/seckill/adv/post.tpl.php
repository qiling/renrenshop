     ...
     <div class="page-sub-toolbar">
        <span class=''>
            <?php if(cv('seckill.adv.add')) { ?>
                <a class="btn btn-primary btn-sm" href="<?php  echo webUrl('seckill/adv/add')?>">添加新幻灯片</a>
            <?php  } ?>
        </span>
     </div>
    <form <?php if( ce('seckill.adv' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php  echo $item['id'];?>" />
 
                <div class="form-group">
                    <label class="col-lg control-label">排序</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if( ce('seckill.adv' ,$item) ) { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <span class='help-block'>建议尺寸:150 * 150 , 正方形</span>
                        <?php  } else { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="input-group">
                            <input type="text" name="link" class="form-control" value="<?php  echo $item['link'];?>" id="advlink" />
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <?php  } ?>
                       <input type="button" name="back" onclick='history.back()' <?php if(cv('seckill.adv')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default" />
                    </div>
            </div>
