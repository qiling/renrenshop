...
<div class="page-content">
    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <div class="tab-content">
            <div class="tab-pane  <?php  if($_GPC['tab']=='basic' || empty($_GPC['tab'])) { ?>active<?php  } ?>" id="tab_basic"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('task/post/rankbasic', TEMPLATE_INCLUDEPATH)) : (include template('task/post/rankbasic', TEMPLATE_INCLUDEPATH));?></div>
            <div class="tab-pane  <?php  if($_GPC['tab']=='design') { ?>active<?php  } ?>" id="tab_design"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('task/post/design', TEMPLATE_INCLUDEPATH)) : (include template('task/post/design', TEMPLATE_INCLUDEPATH));?></div>
            <div class="tab-pane  <?php  if($_GPC['tab']=='resp') { ?>active<?php  } ?>" id="tab_resp" ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('task/post/resp', TEMPLATE_INCLUDEPATH)) : (include template('task/post/resp', TEMPLATE_INCLUDEPATH));?></div>
            <div class="tab-pane <?php  if($_GPC['tab']=='reward') { ?>active<?php  } ?>" id="tab_reward"  ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('task/post/rankreward', TEMPLATE_INCLUDEPATH)) : (include template('task/post/rankreward', TEMPLATE_INCLUDEPATH));?></div>
            <div class="tab-pane <?php  if($_GPC['tab']=='commission') { ?>active<?php  } ?>" id="tab_commission"  ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('task/post/commission', TEMPLATE_INCLUDEPATH)) : (include template('task/post/commission', TEMPLATE_INCLUDEPATH));?></div>
        </div>
        ...
        <div class="form-group"></div>
            <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <?php  } ?>
                       <input type="button" name="back" onclick='history.back()' <?php if(cv('task.add|task.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default" />
                    </div>
            </div>
    </form>
</div>
