...
<div class="page-content">
    ...
    <div class="row hide" id="select" style="max-width: 850px;margin: auto">
        ...
        <div class="col-sm-4">
            <a class="widget" data-type='<?php  echo json_encode($type)?>' data-name="<?php  echo $type['type_key'];?>">
                <h2><?php  echo $type['type_name'];?></h2>
                <ul class="list-unstyled m-t-md">
                    <li><?php  echo $type['description'];?></li>
                </ul>
            </a>
        </div>
        <?php  } } ?>
    ...
    <div id="post" class="hide">
        ...
        <div class="tab-content">
            <div id="basic" class="tab-pane active">
                <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../../plugin/task/template/web/new/post/basic', TEMPLATE_INCLUDEPATH)) : (include template('../../plugin/task/template/web/new/post/basic', TEMPLATE_INCLUDEPATH));?>
            </div>
            <div id="design" class="tab-pane">
                <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../../plugin/task/template/web/new/post/design', TEMPLATE_INCLUDEPATH)) : (include template('../../plugin/task/template/web/new/post/design', TEMPLATE_INCLUDEPATH));?>
            </div>
            <div id="reward" class="tab-pane">
                <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../../plugin/task/template/web/new/post/reward', TEMPLATE_INCLUDEPATH)) : (include template('../../plugin/task/template/web/new/post/reward', TEMPLATE_INCLUDEPATH));?>
            </div>
            <div id="followreward" class="tab-pane">
                <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../../plugin/task/template/web/new/post/followreward', TEMPLATE_INCLUDEPATH)) : (include template('../../plugin/task/template/web/new/post/followreward', TEMPLATE_INCLUDEPATH));?>
            </div>
            <div id="level_2" class="tab-pane">
                <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../../plugin/task/template/web/new/post/level_2', TEMPLATE_INCLUDEPATH)) : (include template('../../plugin/task/template/web/new/post/level_2', TEMPLATE_INCLUDEPATH));?>
            </div>
            <div id="level_3" class="tab-pane">
                <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../../plugin/task/template/web/new/post/level_3', TEMPLATE_INCLUDEPATH)) : (include template('../../plugin/task/template/web/new/post/level_3', TEMPLATE_INCLUDEPATH));?>
            </div>
        </div>
        <br><br>
...
<script>
    ...
    myrequire(['../../plugin/task/static/js/post'], function(model){
        modelObj = model;
        model.init("<?php  echo $task['type'];?>",'<?php  echo $task["reward"];?>','<?php  echo $task["followreward"];?>');
    });
