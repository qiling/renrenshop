...
<div class="page-content">
    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <div class="tab-content">
            <div class="tab-pane  <?php  if($_GPC['tab']=='basic' || empty($_GPC['tab'])) { ?>active<?php  } ?>" id="tab_basic"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('task/post/basic', TEMPLATE_INCLUDEPATH)) : (include template('task/post/basic', TEMPLATE_INCLUDEPATH));?></div>
            ...
            <div class="tab-pane <?php  if($_GPC['tab']=='reward') { ?>active<?php  } ?>" id="tab_reward"  ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('task/post/reward', TEMPLATE_INCLUDEPATH)) : (include template('task/post/reward', TEMPLATE_INCLUDEPATH));?></div>
