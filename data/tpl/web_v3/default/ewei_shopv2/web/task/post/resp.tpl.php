<?php defined('IN_IA') or exit('Access Denied');?><div class="alert alert-primary">用户扫描海报后接收的推送内容</div>
...
<div class="form-group">
    <label class="col-lg control-label">推送文字</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('task' ,$item) ) { ?>
        <textarea name="resptext" class="form-control" rows="5"><?php  echo $item['resptext'];?></textarea>
        <span class="help-block">如果设置为空，则不推送内容</span>
        <?php  } else { ?>
