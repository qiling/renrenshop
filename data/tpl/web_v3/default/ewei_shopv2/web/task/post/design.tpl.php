                                ...
                                <tr>
                                    <td style='width:320px;padding:10px;' valign='top'>
                                        <div id='task'>
                                          ...
                                          <div class="drag" type="<?php  echo $d['type'];?>" title="<?php  echo $d['title'];?>" index="<?php  echo $key+1?>" style="zindex:<?php  echo $key+1?>;left:<?php  echo $d['left'];?>;top:<?php  echo $d['top'];?>;
                                               width:<?php  echo $d['width'];?>;height:<?php  echo $d['height'];?>" 
                                               src="<?php  echo $d['src'];?>" size="<?php  echo $d['size'];?>" color="<?php  echo $d['color'];?>"
                                               > 
                                               <?php  if($d['type']=='qr') { ?>
                                                 <img src="../addons/ewei_shopv2/plugin/task/static/images/qr.jpg" />
                                                <?php  } else if($d['type']=='head') { ?>
                                                  <img src="../addons/ewei_shopv2/plugin/task/static/images/head.jpg" />
                                                <?php  } else if($d['type']=='img' || $d['type']=='thumb') { ?>
                                                  <img src="<?php echo empty($d['src'])?'../addons/ewei_shopv2/plugin/task/static/images/img.jpg':tomedia($d['src'])?>" />
			                                    ...
			                                    <?php  } else if($d['type']=='time') { ?>
                                                   <div class=text style="font-size:<?php  echo $d['size'];?>;color:<?php  echo $d['color'];?>"><?php  echo $d['title'];?></div>
                                              ...
                                              <div class='panel-body'>
                                                <div class="form-group" id="bgset">
                                                  ...
                                                  <div id='timeset' style='display:none'>
                                                      <div class="form-group">
                                                          <label class="col-lg control-label">提示标题</label>
                                                          <div class="col-sm-9 col-xs-12">
                                                              <input type="text" id="timename" class="form-control namesize" value="到期时间" />
                                                          </div>
                                                      </div>
                                                      <div class="form-group">
                                                          <label class="col-lg control-label">文字颜色</label>
                                                      ...
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-4">
                                                              <div class='input-group'>
                                                                  <input type="text" id="timesize" class="form-control namesize" placeholder="例如: 14,16"  />
                                                                  <div class='input-group-addon'>px</div>
                                                              </div>
                                                          </div>
                                                      </div>
                                                  ...
                                                  <div class="form-group" id="headset" style="display:none">
                                                      <label class="col-lg control-label">头像设置</label>
                                                      <div class="col-sm-9 col-xs-12">
                                                          <img src="../addons/ewei_shopv2/plugin/task/static/images/head.jpg" width="80px" height="80px" type="default" class="head_set"/>
                                                          <img src="../addons/ewei_shopv2/plugin/task/static/images/head.jpg" width="80px" height="80px" type="img-rounded" class="head_set img-rounded"/>
                                                          <img src="../addons/ewei_shopv2/plugin/task/static/images/head.jpg" width="80px" height="80px" type="img-circle" class="head_set img-circle"/>
                                                      </div>
                                                  </div>
