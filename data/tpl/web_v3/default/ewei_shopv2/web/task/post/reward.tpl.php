...
<div class="form-group">
    ...
    <div id="selected_rec_reward" class="col-sm-9 col-xs-12">
        ...
        <?php  if($key=='credit') { ?>
        <?php  if($rec>0) { ?>
        <p><button  class="btn btn-success btn-xs rec_reward_data " id="rec_credit" type="button" data-type="1" data-value="<?php  echo $rec;?>">积分：<?php  echo $rec;?> <span class="badge pull-right" data-new="0" data-type="1" data-datatype="1" data-value="0" onclick="del_data(this);">x</span></button>
        </p>
        <?php  } ?>
        <?php  } else if($key=='money') { ?>
        <?php  if($rec['num']>0) { ?>
        <p><button  class="btn btn-success btn-xs rec_reward_data" id="rec_money" type="button" data-type="2" data-value="<?php  echo $rec['num'];?>" data-moneytype="<?php  echo $rec['type'];?>">奖金[<?php echo $rec['type']==0?'余额':'微信';?>]：<?php  echo $rec['num'];?>元 <span class="badge pull-right" data-new="0" data-type="1" data-datatype="2" data-value="0" onclick="del_data(this);">x</span></button>
        </p>
        <?php  } ?>
        <?php  } else if($key=='bribery') { ?>
        <?php  if($rec>0) { ?>
        <p><button  class="btn btn-success btn-xs rec_reward_data" id="rec_bribery" type="button" data-type="3" data-value="<?php  echo $rec;?>">红包：<?php  echo $rec;?>元 <span class="badge pull-right" data-new="0" data-type="1" data-datatype="3" data-value="0" onclick="del_data(this);">x</span></button>
        </p>
        <?php  } ?>
        ...
        <p><button class="btn btn-success btn-xs rec_reward_data" id="rec_goods<?php  echo $ke;?>_<?php  echo $specgoods['goods_spec'];?>" type="button" data-type="4" data-goodsid="<?php  echo $ke;?>" data-goodsname="<?php  echo $goods['title'];?>" data-goodsnum="<?php  echo $goods['total'];?>" data-goodsprice="<?php  echo $goods['marketprice'];?>" data-goodsec="0" data-specname=''>商品：<?php  echo $goods['title'];?>(无规格)[<?php  echo $goods['marketprice'];?>元] <span class="badge pull-right" data-new="0" data-type="1" data-datatype="4" data-value="<?php  echo $ke;?>" onclick="del_data(this);">x</span></button>
        </p>
        <?php  } else { ?>
        <?php  if(is_array($goods['spec'])) { foreach($goods['spec'] as $k => $specgoods) { ?>
        <p><button class="btn btn-success btn-xs rec_reward_data" id="rec_goods<?php  echo $ke;?>_<?php  echo $specgoods['goods_spec'];?>" type="button" data-type="4" data-goodsid="<?php  echo $ke;?>" data-goodsname="<?php  echo $goods['title'];?>" data-goodsnum="<?php  echo $specgoods['total'];?>" data-goodsprice="<?php  echo $specgoods['marketprice'];?>" data-goodsec="<?php  echo $specgoods['goods_spec'];?>" data-specname="<?php  echo $specgoods['goods_specname'];?>">商品：<?php  echo $goods['title'];?>(<?php  echo $specgoods['goods_specname'];?>)[<?php  echo $specgoods['marketprice'];?>元] <span class="badge pull-right" data-new="0" data-type="1" data-datatype="4" data-value="<?php  echo $specgoods['goods_spec'].'-'.$ke;?>" onclick="del_data(this);">x</span></button>
        </p>
        <?php  } } ?>
        <?php  } ?>
        <?php  } } ?>
        ...
        <p><button class="btn btn-success btn-xs rec_reward_data" id="rec_coupon<?php  echo $coupon['id'];?>" type="button" data-type="5" data-couponid="<?php  echo $coupon['id'];?>" data-couponname="<?php  echo $coupon['couponname'];?>" data-couponnum="<?php  echo $coupon['couponnum'];?>">优惠券：<?php  echo $coupon['couponname'];?>[<?php  echo $coupon['couponnum'];?>张] <span class="badge pull-right" data-new="0" data-type="1" data-datatype="5" data-value="<?php  echo $coupon['id'];?>" onclick="del_data(this);">x</span></button>
        </p>
        <?php  } } ?>
        <?php  } ?>
        <?php  } } ?>
...
<script type="text/javascript">
    ...
    function addrecReward(datatype) {
        if(datatype==1){
            ...
            if(reccredit>0){
                var btn_data = '<p><button class="btn btn-success btn-xs rec_reward_data" id="rec_credit" type="button" data-type="1" data-value="'+reccredit+'">积分：'+reccredit+' <span class="badge pull-right" data-type="1" data-datatype="1" data-value="0" data-new="0" onclick="del_data(this);">x</span></button></p>';
                var rec_credit = $('#rec_credit');
                if(rec_credit.length>0){
                    ...
                    $('#selected_rec_reward').append(btn_data);
                }
            }
        }
        if(datatype==2){
            ...
            if(recmoney>0){
                var rec_money = $('#rec_money');
                var moneytype='余额';
                if(recmoneytype==1){
                    moneytype='微信';
                }
                var btn_data = '<p><button class="btn btn-success btn-xs rec_reward_data" id="rec_money" type="button" data-type="2" data-value="'+recmoney+'" data-moneytype="'+recmoneytype+'">奖金['+moneytype+']：'+recmoney+'元 <span class="badge pull-right" data-type="1" data-datatype="2" data-value="0" data-new="0" onclick="del_data(this);">x</span></button></p>';
        ...
        if(datatype==3){
            ...
            if(recbribery>0){
                var btn_data = '<p><button class="btn btn-success btn-xs rec_reward_data" id="rec_bribery" type="button" data-type="3" data-value="'+recbribery+'">红包：'+recbribery+'元 <span class="badge pull-right" data-type="1" data-datatype="3" data-value="0" data-new="0" onclick="del_data(this);">x</span></button></p>';
                var rec_bribery = $('#rec_bribery');
                    ...
                    $('.goods-data').each(function () {
                        ...
                        if(goods_id>0){
                            ...
                            if(goods_select.length>0){
                                ...
                                $('#selected_rec_reward').append(reward_select);
                            }
            ...
            if(modaltype=='coupon'){
                ...
                if($('.coupon-data').length>0) {
                    $('.coupon-data').each(function () {
                        ...
                        if(couponid>0){
                            reward_select='<p><button class="btn btn-success btn-xs rec_reward_data" id="rec_coupon'+couponid+'" type="button" data-type="5" data-couponid="'+couponid+'" data-couponname="'+couponname+'" data-couponnum="'+couponnum+'">优惠券：'+couponname+'['+couponnum+'张] <span class="badge pull-right" data-type="1" data-datatype="5" data-value="'+couponid+'" onclick="del_data(this);">x</span></button></p>';
                            var coupon_select = $('#rec_coupon'+couponid);
