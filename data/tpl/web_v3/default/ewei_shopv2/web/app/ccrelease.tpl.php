                ...
                <div class="col-sm-12">
                    <div class="summary_box">
                        <div class="summary_title">
                            <span class="text-default title_inner">使用说明</span>
                        </div>
                        <div class="summary_lg">
                              <p>如果你还没有注册微信小程序，<a href="https://mp.weixin.qq.com" target="_blank">点击此处注册</a>；注册成功后，设置小程序所有项目</p>
                             <p>然后使用微信开发者工具，将人人商城小程序前端提交到微信官方平台；官方审核后提交上线即可使用。</p>
                        </div>
                    </div>
                </div>
            </div>
