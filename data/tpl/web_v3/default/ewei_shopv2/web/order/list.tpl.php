...
<div class="page-header">
    ...
    <span>订单数:  <span class='text-danger'><?php  echo $total;?></span> 订单金额:  <span class='text-danger'><?php echo empty($totalmoney) ? 0.00 : $totalmoney?></span> <?php  if(!empty($magent['nickname'])) { ?>订单推广人:  <span class='text-danger'><?php  echo $magent['nickname'];?></span><?php  } ?></span>
</div>
