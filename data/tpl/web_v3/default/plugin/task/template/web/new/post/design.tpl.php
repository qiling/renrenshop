<?php defined('IN_IA') or exit('Access Denied');?>
    <input type="hidden" name="design_data">
        ...
        <table style='width:100%;'>
            <tr>
                <td style='width:320px;padding:10px;' valign='top'>
                    <div id='task'>
                        <?php  if(!empty($task['design_bg'])) { ?>
                        <img src='<?php  echo tomedia($task['design_bg'])?>' class='bg'/>
                        <?php  } ?>
                        <?php  if(!empty($design_data)) { ?>
                        <?php  if(is_array($design_data)) { foreach($design_data as $key => $d) { ?>
                        ...
                        <div class='panel-body'>
                            <div class="form-group" id="bgset">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <?php  echo tpl_form_field_image2('design_bg',$task['design_bg'])?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    ...
                                    <button class='btn btn-default btn-com' type='button' data-type='time' >失效时间</button>
